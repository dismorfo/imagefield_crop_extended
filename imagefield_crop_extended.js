...
Drupal.behaviors.imagefield_crop_extended = {
      ...
      $('.cropbox', context).once(function() {
        ...
        $(this).Jcrop({
          onChange: function(c) {
            ...
            if (undefined == settings.imagefield_crop_extended[id].preview) {
              return;
            }
            var rx = settings.imagefield_crop_extended[id].preview.width / c.w;
            var ry = settings.imagefield_crop_extended[id].preview.height / c.h;
            $('.jcrop-preview', preview).css({
              width: Math.round(rx * settings.imagefield_crop_extended[id].preview.orig_width) + 'px',
              height: Math.round(ry * settings.imagefield_crop_extended[id].preview.orig_height) + 'px',
          ...
          aspectRatio: settings.imagefield_crop_extended[id].box.ratio,
          boxWidth: settings.imagefield_crop_extended[id].box.box_width,
          boxHeight: settings.imagefield_crop_extended[id].box.box_height,
          minSize: [Drupal.settings.imagefield_crop_extended[id].minimum.width, Drupal.settings.imagefield_crop_extended[id].minimum.height], 
          /*
